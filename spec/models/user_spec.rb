...
RSpec.describe User, type: :model do
  describe 'ユーザー新規登録' do
    ...
    it "passwordに半角英数字以外が含まれている場合は登録できないこと" do
    ...
    it "last_nameに全角（漢字・ひらがな・カタカナ）以外が含まれている場合は登録できないこと" do
      @user.last_name = "test"
      @user.valid?
    ...
    it "first_nameに全角（漢字・ひらがな・カタカナ）以外が含まれている場合は登録できないこと" do
    ...
    it "last_name_readingが全角（カタカナ）であれば登録できること" do
      @user.last_name_reading = "テスト"
      expect(@user).to be_valid
    end

    it "last_name_readingに全角（カタカナ）以外が含まれている場合は登録できないこと" do
    ...
    it "first_name_readingが全角（カタカナ）であれば登録できること" do
      @user.first_name_reading = "テスト"
      expect(@user).to be_valid
    end

    it "first_name_readingに全角（カタカナ）以外が含まれている場合は登録できないこと" do
